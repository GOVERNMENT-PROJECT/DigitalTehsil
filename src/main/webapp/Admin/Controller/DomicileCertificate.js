angular.module('AdminHomeApp')
	.controller('DomicileCertificate', function ($scope,$http,$log, $cookies) {
	   ...
	   $http.get("http://localhost:8080/e-Tehsil/webapp/Admin/DomicileCertificateRequest", 
	   ...
	   $scope.Save=function(){
	   		...
	   		$http.post("http://localhost:8080/e-Tehsil/webapp/Admin/DomicileCertificateApproval", obj,
				{ headers: { 'Content-Type': 'application/json' } }).
				   	then(function mySucces(response) {
				      	$log.log("We are Successful");
						$log.log(obj);
					...
					function myError(response) {
						...
						window.location="AdminHome.html#/DomicileCertificate";
					}); 
	   };
